...
const Laptop = ({ shop, addtocart }) => {
    const [showDetail, setShowDetail] = useState(false);
    const [selectedProduct, setSelectedProduct] = useState(null);
    const [filteredProducts, setFilteredProducts] = useState(shop.filter(product => product.cat === 'laptop'));
    ...
    const handleApplyFilter = (filters) => {
        ...
        let results = shop.filter(product => product.cat === 'laptop');
    ...
    return (
        ...
        <div className="category_box">
            ...
            <h1>Välkommen till laptop-kategorin!</h1>
            <p>Här hittar du vårt utbud av laptops. Utforska våra senaste modeller, smarta funktioner och innovativa teknologier.</p>
