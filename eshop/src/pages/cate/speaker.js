...
const Speaker = ({ shop, addtocart }) => {
    const [showDetail, setShowDetail] = useState(false);
    const [selectedProduct, setSelectedProduct] = useState(null);
    const [filteredProducts, setFilteredProducts] = useState(shop.filter(product => product.cat === 'speaker'));
    ...
    const handleApplyFilter = (filters) => {
        ...
        let results = shop.filter(product => product.cat === 'speaker');
    ...
    return (
        ...
        <div className="category_box">
            ...
            <h1>Välkommen till speaker-kategorin!</h1>
            <p>Här hittar du vårt utbud av speakerss. Utforska våra senaste modeller speaker, smarta funktioner och innovativa teknologier.</p>
