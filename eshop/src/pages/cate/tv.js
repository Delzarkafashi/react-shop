...
const TV = ({ shop, addtocart }) => {
    const [showDetail, setShowDetail] = useState(false);
    const [selectedProduct, setSelectedProduct] = useState(null);
    const [filteredProducts, setFilteredProducts] = useState(shop.filter(product => product.cat === 'tv'));
    ...
    const handleApplyFilter = (filters) => {
        ...
        let results = shop.filter(product => product.cat === 'tv');
    ...
    return (
        ...
        <div className="category_box">
            ...
            <p>Här hittar du vårt utbud av tvs. Utforska våra senaste modeller, smarta funktioner och innovativa teknologier.</p>
