...
const Headphones = ({ shop, addtocart }) => {
    const [showDetail, setShowDetail] = useState(false);
    const [selectedProduct, setSelectedProduct] = useState(null);
    const [filteredProducts, setFilteredProducts] = useState(shop.filter(product => product.cat === 'headphones'));
    ...
    const handleApplyFilter = (filters) => {
        ...
        let results = shop.filter(product => product.cat === 'headphones');
    ...
    return (
        ...
        <div className="category_box">
            ...
            <h1>Välkommen till headphones-kategorin!</h1>
            <p>Här hittar du vårt utbud av speakerss. Utforska våra senaste modeller headphones, smarta funktioner och innovativa teknologier.</p>
