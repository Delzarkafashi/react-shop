...
const Phone = ({ shop, addtocart }) => {
    const [showDetail, setShowDetail] = useState(false);
    const [selectedProduct, setSelectedProduct] = useState(null);
    const [filteredProducts, setFilteredProducts] = useState(shop.filter(product => product.cat === 'phone'));
    ...
    const handleApplyFilter = (filters) => {
        ...
        let results = shop.filter(product => product.cat === 'phone');
    ...
    return (
        ...
        <div className="category_box">
            ...
            <h1>Välkommen till phone-kategorin!</h1>
            <p>Här hittar du vårt utbud av speakerss. Utforska våra senaste phone, smarta funktioner och innovativa teknologier.</p>
